...
<div class="team__wrap">
    ...
    ?>
        <article data-image-list="<?php echo $team_img['url']; ?>">
            <a href="#<?php echo $member_id; ?>" title="<?php echo $team_name; ?>" class="team__modal">
            ...
            <h5><?php echo $team_name.$job_title; ?></h5>
        </article>
    <?php endforeach; ?>
</div><!-- team__wrap -->
    ...
    ?>
        <div id="<?php echo $member_id; ?>" class="team__popup">
            ...
            <div class="team__popup__content">
                ...
                <h3><?php echo $team_name; ?> <span><?php the_field('team_job_title', $team_id); ?></span></h3>
